...
import { FaBars, FaCogs, FaPlug, FaCode, FaHome, FaPowerOff } from "react-icons/fa";
...
const Sidebar = ({ children }) => {
    ...
    useEffect(() => {
        // Fetch version from package.json when component mounts
        fetch('/api')
        ...
        <div className="sidebar-container">
            <div style={{ width: isOpen ? "200px" : "50px" }} className="sidebar">
                <div className="top-section">
                    <h1 style={{ display: isOpen ? "block" : "none" }} className="logo">v{version}</h1>
