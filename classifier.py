...
from utils.nlp_utils import clean_text, encode_word_vec, pad_sequence

class Classifier:
    def __init__(self, intent_model, vocab_file):
    ...
    def predict_intent(self, text):
        ...
        tag, skill = label.split('-')
        return tag, skill, round(float(prediction[argmax])*100, 3)